...
async function loadMarkdownContent(section) {
    try {
        ...
        } else if (section === 'audit_checkpoints' || section === 'latest_checkpoints' || section === 'latest_technical' || section === 'latest_additional' || section === 'security_iso27001' || section === 'gov_quality_manual' || section === 'data_quality_assessment' || section === 'proposal_management' || section === 'learning_growth' || section === 'social_identity_auth' || section === 'ai_development_methodology' || section === 'cerebras_ai' || section === 'diffusion_llm' || section === 'ai_dlc' || section === 'compound_ai' || section === 'rag' || section === 'ai_dlc_bolt_mob') {
