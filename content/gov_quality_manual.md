...
제품 품질지표는 사용자 관점에서 정보시스템의 품질 특성을 평가하기 위한 지표입니다.

- **기반 표준**: 국제 표준인 ISO/IEC 25000 (SQuaRE) 모델을 활용합니다.
- **측정 범위**: 프로젝트 단위, 서브프로젝트 단위, 점증적 개발 단위에서 적용됩니다.
- **8대 품질 특성 및 지표(예시)**: 총 8개 특성과 31개 부특성을 기준으로 지표를 도출합니다.
    - **기능 적합성**: 기능 요구사항 반영률, 기능 요구사항 정확성 등.
    - **성능 효율성**: 평균 응답시간, CPU 사용률, 메모리 사용률 등.
    - **신뢰성**: 평균 무고장 시간(MTBF), 평균 회복 시간, 결함 허용성 등.
    - **보안성**: 데이터 암호화, 접근 감사성 등.
    - **기타**: 사용성(학습 용이성), 양립성(데이터 교환성), 유지보수성(수정 복잡도), 이식성 등.
